...
/**
 * Conversa do PRESTADOR — usa o módulo de chat premium. O prestador CRIA
 * propostas e visitas, então esses formulários vivem no slot `aboveComposer`
 * do `ChatConversationView`; as mensagens reais são convertidas pelo adaptador.
 */
